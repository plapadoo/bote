...
ssh "$SSH_USER@$HOST_WWW" "docker run --port 12649:8081 --volume /srv/bote-monica:/etc/bote --volume /srv/bote-monica:/var/lib/bote --name=bote --restart=always --detach $HOST_REGISTRY/bote"
